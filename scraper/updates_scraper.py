...
class UpdatesScraper(Scraper):
    ...
    def __init__(self) -> None:
        super().__init__({}, {})
        self.existing_categories: dict = load_data(Path(BASE_PATH / "json_files/categories.json"))
        self.existing_recipes: dict = load_data(Path(BASE_PATH / "json_files/parsed_recipes.json"))
    ...
    def check_new_categories(self) -> None:
        ...
        if new_categories_found := {
            ...
            save_data_to_json(new_categories, str(BASE_PATH / "json_files/categories.json"))
        else:
    ...
    def check_new_recipes_from_category(self, category_name: str, category_url: str) -> None:
        ...
        if new_recipes_found := {
            ...
            save_data_to_json(self.existing_recipes, str(BASE_PATH / "json_files/parsed_recipes.json"))
